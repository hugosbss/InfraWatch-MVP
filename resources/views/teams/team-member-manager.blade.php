<div>
        ...
        <div class="mt-10 sm:mt-0">
            <x-form-section submit="addTeamMember">
                ...
                <x-slot name="description">
                    Convide uma pessoa para colaborar nos monitoramentos, incidentes e alertas desta equipe.
                </x-slot>

                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
                            Informe o email da pessoa que voce deseja adicionar a esta equipe.
                        </div>
                    </div>
                    ...
                    @if (count($this->roles) > 0)
                        <div class="col-span-6 lg:col-span-4">
                            <x-label for="role" value="Permissao" />
    ...
    @if ($team->teamInvitations->isNotEmpty() && Gate::check('addTeamMember', $team))
        ...
        <div class="mt-10 sm:mt-0">
            <x-action-section>
                ...
                <x-slot name="description">
                    Estas pessoas receberam um convite por email e poderao entrar na equipe ao aceitar o link.
                </x-slot>
    ...
    <x-confirmation-modal wire:model.live="confirmingTeamMemberRemoval">
        ...
        <x-slot name="content">
            Tem certeza que deseja remover esta pessoa da equipe?
        </x-slot>
